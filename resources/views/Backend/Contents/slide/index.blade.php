	                    ...
	                    <table class="table table-bordered table-hover table-vcenter">
	                        <thead>
	                            <tr>
	                                ...
	                                ng-click="actions.orderBy('status')">{!! trans('backend.slide.status') !!}</th>
	                                <th>{!! trans('backend.slide.action') !!}</th>
	                            </tr>
	                        </thead>
	                        <tbody>
