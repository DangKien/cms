	...
	<div id="content-container">
		<div id="page-head">
            ...
            <ol class="breadcrumb">
				...
				<li><a href="#">{{ isset($language) ? trans('backend.language.update') : trans('backend.language.create') }}</a></li>
            </ol>
        </div>
		<div id="page-content">
	        <div class="panel">
		            ...
		            <div class="panel-heading">
		               	<div class="panel-heading">
			                <h3 class="panel-title text-main text-bold mar-no">
			                	<i class="ti-pencil"></i> {{ isset($language) ? trans('backend.language.update') : trans('backend.language.create') }} 
			                </h3>
			            </div>
		            </div>
		                    ...
		                    <div class="row">
                                ...
                                <div class="col-sm-10"  style="margin-bottom: 15px;">
                                    <div class="form-group has-feedback row">
        	                            <label class="col-sm-3 control-label text-bold" style="padding-top: 10px;">{!! trans('backend.language.status') !!}</label>
        	                            <div class="col-sm-7">
        	                                <div class="radio">
        	                                    ...
        	                                    checked 
        	                                    >
        	                                    <label for="AVAILABLE"> {!! trans('backend.language.available') !!}</label>
        	                                    ...
        	                                    @if (statusDisable(old('status')))
													checked
        	                                    @endif>
        	                                    <label for="DISABLE"> {!! trans('backend.language.disable') !!}</label>
        	                                </div>
        	                        	</div>
                                	</div>
                            	</div>
