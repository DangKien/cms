...
@section ('myCss')
    ...
    <link href="{{ url('Nifty/plugins/x-editable/css/bootstrap-editable.css') }}" rel="stylesheet">
    <style>
        a.status-1{
            font-weight: bold;
        }
...
@section ('myJs')
    ...
    <script src="{{ url('Nifty/plugins/x-editable/js/bootstrap-editable.min.js') }}"></script>
